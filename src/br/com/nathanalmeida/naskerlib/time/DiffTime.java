...
/**
 * Essa é a direfença no tempo, ele ajusta o tempo de acordo com os ajuste feitos.
 * <p>
...
public class DiffTime{
    ...
    public DiffTime(long adjustmentMilisecond){
        this.adjustmentMilisecond = adjustmentMilisecond;
    }

    public DiffTime(String... fromString){
